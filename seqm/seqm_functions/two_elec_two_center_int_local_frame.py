...
def two_elec_two_center_int_local_frame(ni,nj,r0, tore, da0,db0, qa0,qb0, rho0a,rho0b, rho1a,rho1b, rho2a,rho2b ):
    ...
    riXH[...,0] = eeXH
    riXH[...,1] = ev1 / sqrt((rXH + daXH)**2 + adeXH) \
                - ev1 / sqrt((rXH - daXH)**2 + adeXH)
    riXH[...,2] = eeXH + ev2 / sqrt((rXH + qaXH)**2 + aqeXH) \
                       + ev2 / sqrt((rXH - qaXH)**2 + aqeXH) \
                       - ev1dsqr6XH
    riXH[...,3] = eeXH + ev1 / sqrt(rXH**2 + qaXH**2 + aqeXH) - ev1dsqr6XH
    ...
    ri[...,12] = -dze + ev3/sqrt((r+da-qb)**2 + adq) \
    ...
    #sqr(54)-sqr(72) use qa1 and qb1
    ri[...,19] = ev3/sqrt((r+qa1-qb1)**2 + (qa1-qb1)**2 + aqq) \
